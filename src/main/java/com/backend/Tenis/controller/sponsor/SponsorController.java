...
public class SponsorController {
    ...
    public ResponseEntity<ResponseSponsorDTO> findById(@PathVariable Long id) {
    ...
    @PostMapping("/sponsor")
    public ResponseEntity<RequestSponsorDTO> save(@RequestBody Sponsor sponsor) {
    ...
    @PutMapping("/sponsor")
    public ResponseEntity<ResponseSponsorDTO> update(@RequestBody Sponsor sponsor) {
